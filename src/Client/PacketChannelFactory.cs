...
namespace System.Net.Mqtt
{
    internal class PacketChannelFactory : IPacketChannelFactory
	{
		...
		IEnumerable<IFormatter> GetFormatters ()
		{
			...
			formatters.Add (new IdentifiablePacketFormatter<PublishAck> (MqttPacketType.PublishAck, id => new PublishAck (id)));
			formatters.Add (new IdentifiablePacketFormatter<PublishReceived> (MqttPacketType.PublishReceived, id => new PublishReceived (id)));
			formatters.Add (new IdentifiablePacketFormatter<PublishRelease> (MqttPacketType.PublishRelease, id => new PublishRelease (id)));
			formatters.Add (new IdentifiablePacketFormatter<PublishComplete> (MqttPacketType.PublishComplete, id => new PublishComplete (id)));
			...
			formatters.Add (new IdentifiablePacketFormatter<UnsubscribeAck> (MqttPacketType.UnsubscribeAck, id => new UnsubscribeAck (id)));
